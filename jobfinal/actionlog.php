            	...
            	<div class="left_col">
            	  ...
            	  <div class="main_news_con">
                        ...
                        <td><select name="date" id="date" onchange="getlog()">
                           ...
                           <!-- <option value="2016-10-30">30th Oct</option>
                            <option value="2016-10-31">31st Oct</option>
                            <option value="2016-11-01">1st Nov</option>
                            <option value="2016-11-02">2nd Nov</option>
                            <option value="2016-11-03">3rd Nov</option>
                            <option value="2016-11-04">4th Nov</option>
                            <option value="2016-11-05">5th Nov</option>
                            <option value="2016-11-06">6th Nov</option>-->
                            <option value="2016-11-07">7th Nov</option>
                            <option value="2016-11-08">8th Nov</option>
                            
                            <!--<option value="2016-11-10">10th Nov</option>
                            <option value="2016-11-11">11th Nov</option>
                            <option value="2016-11-12">12th Nov</option>-->
