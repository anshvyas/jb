                    ...
                    <div class="main_news_con">
                        <div class="main_news_post">
                            <div class="clr">
                                ...
                                <h2 align="center">Unlock a user</h2>
                                <font size=2>
                                    <form action="unlockuserdata.php" method="post">
                                        <table>
                                            <tr><B>Select users to be unlocked<b></b></tr>
                                            <br><br><br>
                                            ...
                                            $sql = "SELECT * FROM profile where flag=1 and usertype='user'   ";
                                            ...
                                            while ($row = mysql_fetch_array($data))
                                            {
                                                $id = "visible" . $i;
                                                $i++; ?>
                                                <tr><input type="checkbox" id=<?php echo $id; ?> name=<?php echo $id; ?>
                                                           value="1"/>  <?php echo  $row[0]; ?>
                                                <tr/><br><br>
                                                <?php
