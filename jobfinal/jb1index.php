        ...
        <div class="con3">
            ...
            <div class="main_con">
                <div class="left_col">
                    ...
                    <h1 align="left"><u>Developers of Job Bureau v1.0<u></u></h1><br><Br>
                        <table cellpadding="5" cellspacing="10" width="100%">

                            <tr>
                           <td width="50%">
                                <h2>Chaitanya Gupta</h2>


                        <h4>chaitanyagpt.21@gmail.com</h4>
                        <h4>
                            (+91-9009752059)
                        </h4></td>
                                <td width="50%">
                                     <h2>Swapnil Srivastava</h2>


                             <h4>swapnilmissu@gmail.com</h4>
                             <h4>
                                 (+91-9406989981)
                             </h4></td>
                  ...
                  <h2 align="left"><u>Event Executives of Job Bureau v1.0<u></u></h2><br>
                          <table cellpadding="5" cellspacing="10" width="100%">

                            <tr>
                           <td width="50%">
                                <h2>Himanshu Sardana</h2>


                        <h4>himanshu.sardana@infotsav.org</h4>
                        <h4>
                            (+91-7828190005)
                        </h4></td>
                                <td width="50%">
                             ...
                             <h4>nitin.mathur@infotsav.org</h4>
                             <h4>
                                 (+91-8827569525)
                             </h4></td>
                ...
                <div class="right_col1" style="background-color: #FFFFFF;">
